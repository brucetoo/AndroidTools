...
public class RequestRunnable implements Runnable {
    ...
    private static final String KEY_FROM = "AndroidTools";
    private static final String KEY = "837638964";
    private Editor mEditor;
    private String mQuery;

    //http://fanyi.youdao.com/openapi.do?keyfrom=AndroidTools&key=837638964&type=data&doctype=<doctype>&version=1.1&q=要翻译的文本
    ...
    public void run() {
        try {
            ...
            if (status >= 200 && status < 300) {
                ...
                NotificationHelper.info(translation.toString());
            } else {
